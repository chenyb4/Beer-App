...
<div class="p-5 flex ">
    <div class="overflow-auto p-5 bg-light-s_bg dark:bg-dark-s_bg rounded-2xl">
        <h1 class="text-3xl m-5 ml-2 font-bold">
            Student administration
        </h1>
        <Table color="custom" noborder class="text-s bg-light-s_bg dark:bg-dark-s_bg border-light-p_bg dark:border-dark-p_bg">
            <TableHead>
                <TableHeadCell
                ...
                <TableHeadCell
                        class="border-light-s_bg dark:border-dark-s_bg border-b-8 text-xs uppercase rounded-r-full bg-light-p_foreground dark:bg-dark-p_foreground"></TableHeadCell>
            </TableHead>
            <TableBody>
                {#if users.length > 0}
                    { #each users as user}
                        <TableBodyRow>
                            <TableBodyCell
                                    tdClass="border-light-s_bg dark:border-dark-s_bg border-b-8 bg-light-p_bg dark:bg-dark-p_bg rounded-l-full px-6 py-4 whitespace-nowrap font-medium ">{user.username}</TableBodyCell>
                            <TableBodyCell
                                    tdClass="border-light-s_bg dark:border-dark-s_bg border-b-8 bg-light-p_bg dark:bg-dark-p_bg px-6 py-4 whitespace-nowrap font-medium">{user.email}</TableBodyCell>
                            <TableBodyCell
                                    tdClass="border-light-s_bg dark:border-dark-s_bg border-b-8 bg-light-p_bg dark:bg-dark-p_bg px-6 py-4 whitespace-nowrap font-medium">{getRole(user.role)}</TableBodyCell>
                            ...
                            <TableBodyCell
                                    tdClass="border-light-s_bg dark:border-dark-s_bg border-b-8 bg-light-p_bg dark:bg-dark-p_bg px-6 py-4 whitespace-nowrap font-medium">{getLanguage(user.language)}</TableBodyCell>
                            <TableBodyCell

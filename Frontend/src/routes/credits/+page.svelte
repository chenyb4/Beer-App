...
<div>
    ...
    <form class="lg:max-w-7xl mx-auto mt-10 bg-light-s_bg dark:bg-dark-s_bg p-12 rounded-lg">
        ...
        <div class="mb-5">
            <label for="student-number" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{$t('credits.studentNumber')}</label>
        ...
        <label for="quantity-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{$t('credits.amountOfCredits')}</label>
        ...
        <button type="submit" style="background-color: #009C82;" class="mt-40 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">{$t('credits.confirm')}</button>
    </form>
